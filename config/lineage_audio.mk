...
ALARM_PATH := vendor/omega/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/omega/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/omega/prebuilt/common/media/audio/ringtones
